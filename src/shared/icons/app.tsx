...
export function SolarCardTransferOutline(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function SolarPieChart2Linear(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}>
      <g fill="none" stroke="currentColor" strokeWidth="1.5">
        <path d="M6.222 4.601a9.499 9.499 0 0 1 1.395-.771c1.372-.615 2.058-.922 2.97-.33c.913.59.913 1.56.913 3.5v1.5c0 1.886 0 2.828.586 3.414c.586.586 1.528.586 3.414.586H17c1.94 0 2.91 0 3.5.912c.592.913.285 1.599-.33 2.97a9.498 9.498 0 0 1-10.523 5.435A9.5 9.5 0 0 1 6.222 4.601Z"></path>
        <path d="M21.446 7.069a8.026 8.026 0 0 0-4.515-4.515C15.389 1.947 14 3.344 14 5v4a1 1 0 0 0 1 1h4c1.657 0 3.053-1.39 2.446-2.931Z"></path>
      </g>
    </svg>
  );
}

export function SolarLogout2Outline(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
      ...
      <g fill="currentColor">
        ...
        <path d="M15 11.25a.75.75 0 0 1 0 1.5H4.027l1.961 1.68a.75.75 0 1 1-.976 1.14l-3.5-3a.75.75 0 0 1 0-1.14l3.5-3a.75.75 0 1 1 .976 1.14l-1.96 1.68H15Z"></path>
      </g>
    </svg>
  );
}

export function MajesticonsDotsVertical(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function SolarTrashBin2Linear(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
      ...
      <g fill="none" stroke="currentColor" strokeWidth="1.5">
        <path
          strokeLinecap="round"
          d="M20.5 6h-17m15.333 2.5l-.46 6.9c-.177 2.654-.265 3.981-1.13 4.79c-.865.81-2.196.81-4.856.81h-.774c-2.66 0-3.991 0-4.856-.81c-.865-.809-.954-2.136-1.13-4.79l-.46-6.9"></path>
...
export function SolarPenOutline(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M14.757 2.621a4.682 4.682 0 0 1 6.622 6.622l-9.486 9.486c-.542.542-.86.86-1.216 1.137c-.418.327-.87.607-1.35.835c-.406.193-.834.336-1.56.578l-3.332 1.11l-.802.268a1.81 1.81 0 0 1-2.29-2.29l1.378-4.133c.242-.727.385-1.155.578-1.562c.229-.479.508-.931.835-1.35c.276-.354.595-.673 1.137-1.215l9.486-9.486ZM4.4 20.821l2.841-.948c.791-.264 1.127-.377 1.44-.526c.38-.182.74-.404 1.073-.663c.273-.214.525-.463 1.115-1.053l7.57-7.57a7.36 7.36 0 0 1-2.757-1.744A7.358 7.358 0 0 1 13.94 5.56l-7.57 7.57c-.59.589-.84.84-1.053 1.114a5.861 5.861 0 0 0-.663 1.073c-.149.313-.262.649-.526 1.44l-.947 2.841L4.4 20.82ZM15.155 4.343c.035.175.092.413.189.69a5.857 5.857 0 0 0 1.4 2.222a5.857 5.857 0 0 0 2.221 1.4c.278.097.516.154.691.189l.662-.662a3.182 3.182 0 0 0-4.5-4.5l-.663.661Z"
        clipRule="evenodd"></path>
    </svg>
  );
}

export function SolarUserCheckRoundedBroken(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
      ...
      <g fill="none" stroke="currentColor" strokeWidth="1.5">
        ...
        <path
          strokeLinecap="round"
          d="M12 13c2.608 0 4.883.815 6.088 2.024m-2.504 5.413C14.536 20.794 13.31 21 12 21c-3.866 0-7-1.79-7-4c0-1.36 1.187-2.56 3-3.283"></path>
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="m18 18.5l1 1l2-2.5"></path>
      </g>
    </svg>
  );
}
