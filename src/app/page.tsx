  ...
  return (
    <>
      <main className="min-h-screen w-full flex">
        <section className="w-1/2 p-10 bg-black text-white hidden lg:flex flex-col justify-between">
        ...
        <section className="w-full lg:w-1/2 bg-white flex gap-2 flex-col items-center justify-center text-black">
